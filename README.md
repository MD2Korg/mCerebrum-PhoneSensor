...
This Android application integrates the smartphone's sensors into mCerebrum's data collection and processing system.

You can find more information about MD2K software on our [software website](https://md2k.org/software) or the MD2K organization on our [MD2K website](https://md2k.org/).

# Install
Download and install the latest [Study](https://github.com/MD2Korg/mCerebrum-Study/releases/latest) and [PhoneSensor](https://github.com/MD2Korg/mCerebrum-PhoneSensor/releases/latest) applications.
...
For the versions available, see [this repository's tags](https://github.com/MD2Korg/mCerebrum-PhoneSensor/tags).

## Contributors

Link to the [list of contributors](https://github.com/MD2Korg/mCerebrum-PhoneSensor/graphs/contributors) who participated in this project.
